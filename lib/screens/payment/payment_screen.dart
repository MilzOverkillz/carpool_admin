...
import 'package:carpool_admin/widgets/dialogs/payment_settings_dialog.dart';
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Row(
                            children: [
                              Image.asset(
                                "assets/icons/payment/buttonicon1.png",
                              ),
                              SizedBox(width: 15),
                              Text(
                                "Process Refund",
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            backgroundColor: Color(0xFFD9D9D9),
                                ...
                                onPressed: () {
                                      showDialog(
                                        context: context,
                                        builder: (_) => const PaymentSettingsDialog(),
                                      );
                                    },
                          child: Row(
                            children: [
                              Image.asset(
                                "assets/icons/payment/buttonicon2.png",
                              ),
                              SizedBox(width: 10),
                              Text(
                                "Payment Setting",
