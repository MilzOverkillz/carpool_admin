...
class AppColors {
  ...
  static const Color white = Color(0xFFFFFFFF); // White (Cards, Modals, Inputs)
  ...
  static const Color surface = Color(
    0xFFF4F7FE,
  ); // White (Cards, Modals, Inputs)

  // Interactive Surfaces (Buttons, Tags)
  static const Color buttonSecondaryBg = Color(
    0xFFE5E7EB,
  ); // Light gray (Process Refund button)
  ...
  static const Color textPrimary = Color(
    0xFF111827,
  ); // Main headings, primary data
  static const Color textSecondary = Color(
    0xFF4B5563,
  ); // Subtitles, table headers, labels
  ...
  static const Color textInverse = Color(
    0xFFFFFFFF,
  ); // Text on dark backgrounds (Sign in btn)
  ...
  static const Color divider = Color(
    0xFFE5E7EB,
  ); // Soft lines separating table rows
  static const Color border = Color(
    0xFFD1D5DB,
  ); // Standard borders (Cards, inactive inputs)

  // Input specific
  static const Color inputBorder = Color(0xFFD1D5DB); // Inactive input border
  static const Color inputFocusBorder = Color(
    0xFF111827,
  ); // Active input border (Black as seen in Sign Up)
  ...
  static const Color scrim = Color(
    0x66000000,
  ); // Semi-transparent black for modal backgrounds
  ...
  static const Color tagPillBg = Color(
    0xFFC7C9CB,
  ); // #C7C9CB from roles/status pills

  static const Color purpleText = Color(
    0xFF6B7280,
  ); // Lighter purple for role pill text
  static const Color outlinedButtonText = Color(
    0xFF6B7280,
  ); // Outlined button text color (purple)
